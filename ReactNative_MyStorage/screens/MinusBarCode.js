...
class MinusBarCode extends React.Component {
  ...
  searchInDb = async () => {
    console.log("searchinf for barcode to subtract");
  ...
  handleBarCodeScanned = ({ data }) => {
    ...
    this.setState({ searchedBarcode: data });
    ...
    return (
      <View style={styles.container}>
        ...
        <Modal
          ...
          transparent={true}
          title="Consume Food from Storage"
          onTouchOutside={() => this.permission()}
        >
...
export default withTranslation()(MinusBarCode);
////////////////////////////////////////////////////////////////////////// STYLY
